...
public class MultiTouch {
	...
	public static void main(String[] args) throws MalformedURLException {
		...
		touch.longPress(LongPressOptions.longPressOptions().withElement(ElementOption.element(ele))).waitAction(WaitOptions.waitOptions(Duration.ofMillis(500))).release();
